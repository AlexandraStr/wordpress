...
/* --------------------------GENERAL SETTINGS-------------------------- */
	...
	$options[] = array(
		'name' => __( 'Upload Logo UK', 'accesspress-root' ),
		'id' => 'logo_uk',
    ...
    $options[] = array(
        'name' => __( 'Upload Logo EN', 'accesspress-root' ),
        'id' => 'logo_en',
        'desc' => __('Standard size of the logo is 280X80px', 'accesspress-root'),
        'type' => 'upload'
    );
...
/* --------------------------GENERAL SETTINGS-------------------------- */
	...
	foreach ($home_order as $key => $value) {
		...
		$options[] = array(
            ...
            $options[] = array(
                'name' => __( 'Service Section Title En', 'accesspress-root' ),
                'id' => 'service_title_en',
                'std' => 'Service',
                'type' => 'text'
            );
		...
		$options[] = array(
            ...
            $options[] = array(
                'name' => __( 'Service Section Desc En', 'accesspress-root' ),
                'id' => 'service_desc_en',
                'settings' => array('rows' => 2),
                'type' => 'textarea'
            );

		for ($service_page_count = 1; $service_page_count <= 6; $service_page_count++) {
			if ( $options_categories ) {
				$options[] = array(
                ...
                $options[] = array(
                    'name' => __( 'Service En ', 'accesspress-root' ).$service_page_count,
                    'id' => 'service_en'.$service_page_count,
                    'type' => 'select',
                    'options' => $options_pages
                );
			}
		...
		$options[] = array(
			...
			$options[] = array(
			'name' => __( 'Feature Section Title En', 'accesspress-root' ),
			'id' => 'feature_title_en',
			'std' => __( 'Our Features', 'accesspress-root' ),
			'type' => 'text'
		);
		...
		$options[] = array(
			...
			$options[] = array(
			'name' => __( 'Feature Section Desc En', 'accesspress-root' ),
			'id' => 'feature_desc_en',
			'settings' => array('rows' => 2),
			'type' => 'textarea'
		);
	...
	/*	for ($service_page_count = 1; $service_page_count <= 4; $service_page_count++) {
		...
		$options[] = array(
			...
			$options[] = array(
			'name' => __( 'Read More Text En', 'accesspress-root' ),
			'id' => 'feature_readmore_en',
			'std' => __( 'Read More', 'accesspress-root' ),
			'type' => 'text'
		);
		...
		if ( $options_pages ) {
			...
			$options[] = array(
				'name' => __( 'Project En', 'accesspress-root' ),
				'id' => 'project_en',
				'type' => 'select',
				'options' => $options_pages
			);
		...
		$options[] = array(
			...
			$options[] = array(
			'name' => __( 'Project Read More En', 'accesspress-root' ),
			'id' => 'project_readmore_en',
			'std' => __( 'Read More', 'accesspress-root' ),
			'type' => 'text'
		);
...
/* --------------------------SLIDER IMAGES-------------------------- */
	...
	$options[] = array(
		'name' => __( 'Slider Title En', 'accesspress-root' ),
		'id' => 'slider_title_en'.$slider_count,
		'type' => 'text'
	);
	...
	$options[] = array(
		'name' => __( 'Slider Description En', 'accesspress-root' ),
		'id' => 'slider_desc_en'.$slider_count,
		'settings' => array('rows' => 2),
		'type' => 'textarea'
	);
	...
	$options[] = array(
		...
		'std' => __( 'Читати далі', 'accesspress-root' ),
		'type' => 'text'
	);

	$options[] = array(
		'name' => __( 'Slider Button Text En', 'accesspress-root' ),
		'id' => 'slider_button_text_en'.$slider_count,
		'std' => __( 'Read More', 'accesspress-root' ),
		'type' => 'text'
	);
	...
	$options[] = array(
		'name' => __( 'Slider Button Link En', 'accesspress-root' ),
		'id' => 'slider_button_link_en'.$slider_count,
		'std' => 'http://',
		'type' => 'url'
	);
	}  
