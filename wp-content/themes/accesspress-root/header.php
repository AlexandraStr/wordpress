	...
	<header id="masthead" class="site-header">
		...
		<div class="ak-container">
			...
			<?php if(of_get_option('logo_setting') == 'image' || of_get_option('logo_setting') == 'image_text') : 
		   	if( get_locale()=="en_US" && of_get_option('logo_en')): ?>
				     <a class="site-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url(of_get_option('logo_en')); ?>" width="150" alt="<?php bloginfo( 'name' ); ?>"/> </a>
				<?php else: ?>
                    <a class="site-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url(of_get_option('logo_uk')); ?>" alt="<?php bloginfo( 'name' ); ?>"/> </a>
                    <?php
				endif;
			endif;
